...
<?php } ?>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart " id="badge" data-notify="0" >
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.php"><img src="images/icons/" alt="IMG-LOGO"></a>
			</div>
...
<script>document.write(new Date().getFullYear());</script> Raj Verma - ecommerce</a>
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<!--  -->
							<div class="p-t-33" id="display_item">
